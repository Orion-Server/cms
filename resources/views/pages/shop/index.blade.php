...
<div class="flex h-screen">
    <div class="w-2/6 xl:w-1/6 h-full bg-slate-850/75 border-r border-slate-700">
        ...
        <div class="flex flex-col w-full">
            <div class="flex flex-col w-full mt-8 bg-slate-900 border-y border-slate-700 text-slate-300 text-sm">
        ...
        <ul class="w-full flex flex-col mt-8 border-t border-slate-600">
            @foreach ($categories as $category)
                <a href="">
                    <li class="p-4 border-b border-slate-600 flex items-center justify-start gap-2 hover:bg-slate-700">
