                        ...
                        <div class="w-full h-full flex flex-col gap-2 p-1">
                            ...
                            <div class="flex w-full flex-col">
                                ...
                                <span class="w-full mt-2 flex gap-2 justify-start items-center text-slate-700 max-h-[45px] overflow-hidden dark:text-slate-400 text-xs">
                                    ...
                                    ></div>
                                    <a class="underline underline-offset-2 hover:text-blue-400" href="{{ $defaultArticle->user ? route('users.profile.show', $defaultArticle->user->username) : '#' }}">{{ $defaultArticle->user->username ?? 'System' }}</a>
                                </span>
                            </div>
                        </div>
                    </div>
