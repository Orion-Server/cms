<div class="flex flex-wrap gap-2 max-h-full overflow-y-auto px-2">
    ...
    <template x-if="!inventoryStore.delay">
        <template x-for="homeItemData in inventoryStore.getItemsForCurrentTab()">
            <div
            ...
            >
                <div
                    ...
                    :class="{ '!border-green-500': false, 'bg-cover no-pixelated': inventoryStore.currentTab == 'backgrounds' }"
