...
return [
    ...
    'resources' => [
        ...
        'achievements' => [
            'navigation_label' => 'Gérer les réalisations',
            'label' => 'Réussite',
            'plural' => 'Réalisations',
        ],
        'emulator-settings' => [
        ...
        'tags' => [
            'navigation_label' => 'Gérer les balises',
            'label' => 'Balise',
            'plural' => 'Balises',
        ],
        'bans' => [
            'navigation_label' => 'Gérer les interdictions',
            'label' => 'Interdiction',
    ...
    'helpers' => [
        'achievement_points' => 'Points de réalisation à récompenser',
        'achievement_progress_needed' => 'Progression nécessaire pour terminer la réalisation',
    ...
    'inputs' => [
        ...
        'achievement_score' => 'Score de réalisation',
        'respects_received' => 'Respects reçus',
        'can_trade' => 'Peut échanger?',
        'block_following' => 'Bloquer les abonnements',
        'block_friendrequests' => 'Bloquer les demandes d\'ami',
        'block_roominvites' => 'Bloquer les invitations de salle',
        'max_rooms' => 'Salles maximales',
        'max_friends' => 'Amis maximaux',
